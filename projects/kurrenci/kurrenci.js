...
function updateDOM(amount, data) {
    ...
    var options = {hour: 'numeric', minute: '2-digit', day: '2-digit', month: 'long', year: 'numeric', timeZoneName: 'short' };
    ...
    for (var conv in conversions){
        ...
        var newExchange = document.createElement('p');
        var currencyOptions = {style: 'currency', currency: conv, currencyDisplay: 'symbol'};
        var conversion;
...
function filterResults(){
    ...
    var symbols = document.querySelectorAll(".currency-conversion");
